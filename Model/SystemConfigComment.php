...
class SystemConfigComment implements \Magento\Config\Model\Config\CommentInterface
{
    ...
    public function getCommentText($elementValue)
    {
        ...
        return 'Using webhook secret keys allows Safepay to verify each payment. To get your sandbox webhook key: <br/>&nbsp;&nbsp; 1. Navigate to your Sandbox Safepay dashboard by clicking <a target="__blank" href="https://sandbox.api.getsafepay.com/dashboard/api-settings">here</a> <br/>&nbsp;&nbsp; 2. Click \'Add an endpoint\' and paste the following URL:<a href=\'#\'> '.$base_url .'safepay/webhook/receiver</a> <br/>&nbsp;&nbsp; 3. Make sure to select "Send me all events", to receive all payment updates. <br/>&nbsp;&nbsp; 4. Click "Show shared secret" and paste into the box above.';
    }
}
